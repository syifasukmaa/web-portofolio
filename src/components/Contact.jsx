...
function Contact() {
  ...
  return (
    <section id="contact" className="w-full pb-44 md:pt-18 font-poppins">
      <motion.div
        initial="hidden"
        whileInView="visible"
        viewport={{ once: true }}
      ...
      >
        <div className="text-center">
          <h4 className="mb-3 text-lg font-bold md:text-xl dark:text-dark700">
            Lets Connect and say Hi!
          </h4>
          <p className="font-normal dark:text-dark600">
            If you’d like to say hi or work with me:
          </p>

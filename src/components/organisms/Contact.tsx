...
function Contact() {
    return (
        <section id="contact" className="w-full py-28 md:pt-18 font-poppins bg-ygBlue dark:bg-dark200">
            <motion.div variants={containerVariant} initial="hidden" whileInView="visible" viewport={{ once: false, amount: 0.2 }} className="w-[90%] mx-auto lg:w-[75%]">
                <div className="text-center">
                    <h3 className="text-2xl font-extrabold text-greys md:text-3xl dark:text-primary100 font-jetbrains">Contact</h3>
                ...
                <div className="grid md:grid-cols-3 grid-cols-1 gap-6 justify-center items-center mt-24">
                    <a href="https://mail.google.com/mail/?view=cm&fs=1&to=syifasukmawork@gmail.com" target="_blank" rel="noopener noreferrer" className="block">
                        <motion.div
                            ...
                            className="bg-white dark:bg-black/20 dark:border-gray-600 rounded-xl py-5 px-5 shadow-lg dark:shadow-md dark:shadow-dark300/80 cursor-pointer hover:scale-105 transition-all ease-in-out duration-300"
                        >

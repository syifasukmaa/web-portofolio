            ...
            >
                <div className="text-center">
                    ...
                    <p className="pt-2 font-light text-greys md:text-xl dark:text-primary400 dark:font-normal">
                        ...
                        if you're looking to hire or collaborate - let's talk
                    </p>
                </div>

                <div className="grid md:grid-cols-3 grid-cols-1 gap-6 justify-center items-center mt-16 md:mt-24 ">
                    <a
                    ...
                    >
                        ...
                        >
                            <div className="flex flex-col items-center ">
                                ...
                                <h4 className="dark:text-white text-blue font-medium mt-4">
                                    Email
                                </h4>
                                <p className="text-sm dark:text-gray-400">
                                    syifasukmawork@gmail.com
                                </p>

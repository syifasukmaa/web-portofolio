        ...
        <div className='w-[90%] mx-auto lg:w-[75%]'>
          <div className='flex items-start justify-center md:flex-col '>
            <div className='flex flex-col items-center justify-start w-1/2 pt-3 md:flex-row md:justify-between md:items-center md:w-full'>
              ...
              />
              <div className='flex flex-col-reverse items-center pl-2 md:flex-row'>
                <p className='my-2 font-light text-center break-all text-dark600'>syifasukmaramadhani@gmail.com</p>
                <Button
                  styling={
                ...
                <Button
                  styling={'flex py-2 md:mx-5 cursor-pointer text-lg hover:font-bold text-dark600 lg:ml-1 lg:mr-0'}
            ...
            <div className='items-center justify-between w-1/2 md:flex md:w-full'>
              <nav className='flex flex-col items-center justify-center md:flex-row md:justify-start lg:items-center lg:border-none lg:bg-transparent lg:shadow-none lg:flex-row '>
                {linkNav.map((link) => (
                  <LinkScroll
                    key={link.id}
                    title={link.title}
                    styling={'md:first:ml-0 md:ml-4 md:mr-4 md:last:mr-0 text-dark600 capitalize'}
                  />
                ))}
              </nav>
          ...
          <p className='px-6 mt-4 font-light text-center break-all text-dark600 md:px-0 md:text-left xl:hidden'>
            Designed and built by <span className='text-transparent gradient-primary bg-clip-text'>Syifa Sukma</span>{' '}
            with
            <span className='text-transparent gradient-secondary bg-clip-text'> Love</span> &{' '}
            <span className='text-transparent gradient-secondary bg-clip-text'>Coffee</span>
          </p>

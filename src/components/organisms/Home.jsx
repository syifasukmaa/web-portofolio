...
function Home() {
    ...
    const buttonStyle = "rounded-xl flex items-center justify-center gap-2 py-3 px-6 font-semibold transition-all duration-300 hover:-translate-y-1";
    const CV = "https://drive.google.com/file/d/1dwvVCvxlGdHtxHIdVdb0fihSXGDSiQoB/view?usp=sharing";
    return (
        <section id="home" className="w-[90%] mx-auto lg:w-[75%] pt-18 md:pt-16">
            <div className="flex flex-col-reverse md:flex-row items-center justify-between gap-10 lg:gap-0 pt-32 pb-14 md:pt-20 lg:py-40 mx-auto text-center md:text-left font-poppins">
                <motion.div initial="hidden" whileInView="show" variants={slideIn("left", "tween", 0.5, 0.7)} className="w-full md:max-w-[45%] lg:max-w-[50%]">
                    <div className=" text-xl font-bold font-poppins lg:text-4xl md:text-3xl ">
                        <div className="flex items-center mx-auto md:ml-0 justify-start gap-2 bg-ygPurple/10 w-fit px-3 py-1 rounded-full mb-6 dark:bg-dark600 dark:text-dark700">
                            ...
                            <p className="text-ygPurple dark:text-ygPurple font-semibold text-sm">Open To Work</p>
                        </div>
                        <p className="font-jetbrains  mb-4 text-ygPurple dark:text-primary100">
                            Hi, my name is
                            <span className="font-jetbrains text-transparent gradient-secondary bg-clip-text"> Syifa Sukma</span>
                        </p>
                        <p className="font-jetbrains mb-2 text-ygPurple dark:text-primary100">I am a</p>
                        <TypeAnimation
                    ...
                    <div className="text-start">
                        <p className="pt-2 text-md text-ygPurple dark:text-dark600 mt-3">
                            {" "}
                            Fresh Graudate information systems majoring. I have a great interest in the IT industry, especially in the fields of web development and data management
                            (administration).
                        </p>
                    </div>
                ...
                >
                    ...
                    <svg viewBox="0 0 100 100" xmlns="http://www.w3.org/2000/svg" className="absolute w-[300px] lg:w-[450px] -mt-14 md:-mt-28 -mr-28 md:-mr-32 opacity-10">
                        <defs>
                        ...
                        <path d="M83,69Q72,88,51.5,85.5Q31,83,17.5,66.5Q4,50,15.5,30Q27,10,49.5,11Q72,12,83,31Q94,50,83,69Z" fill="url(#fill)" />
                    </svg>
                    <svg viewBox="0 0 100 100" xmlns="http://www.w3.org/2000/svg" className="absolute w-[300px] lg:w-[450px] -mt-10 md:-mt-16 -mr-16 md:-mr-20 opacity-10">
                        <defs>
                            <linearGradient id="fill" x1="0%" y1="0%" x2="100%" y2="0%" gradientTransform="rotate(45 0.5 0.5)">
                                <stop offset="0%" stopColor="#4F46E5" />
                                <stop offset="100%" stopColor="#FF7AF9" />
                    ...
                    <svg viewBox="0 0 100 100" xmlns="http://www.w3.org/2000/svg" className="absolute w-[300px] lg:w-[450px]">
                        <defs>
                            <linearGradient id="fill" x1="0%" y1="0%" x2="100%" y2="0%" gradientTransform="rotate(45 0.5 0.5)">
                                <stop offset="0%" stopColor="#4F46E5" />
                                <stop offset="100%" stopColor="#FF7AF9" />
                    ...
                    <img src="/img/sipa.png" alt="Syifa" width={700} height={900} className="relative z-10 w-80 md:w-[380px] lg:w-[500px] -mt-20 md:-mt-36 lg:-mt-44" />
                </motion.div>
            </div>
        </section>
    );
